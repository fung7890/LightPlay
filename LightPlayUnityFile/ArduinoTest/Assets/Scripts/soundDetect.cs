...
public class soundDetect : MonoBehaviour
{
    ...
    int LedPosCalc()
    {
        ...
        {          // bottom of monitor			
            if (angle < 0)
            {                              // conversion to assist with function
                angle = angle * -1 - 135;
            }
            else
            {
